var lmc = /******/ (function (modules) {
  ...
  \************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./Icon */ "./src/Icon.js");
        /* harmony import */ var _LLBBox__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./LLBBox */ "./src/LLBBox.js");
        ...
        var _default = /*#__PURE__*/ (function () {
          ...
          function _default(markerCluster, config, iloader) {
            ...
            this._markers = [];
            this._bounds = null;
            this._clusterIcon = new _Icon__WEBPACK_IMPORTED_MODULE_0__[
              "ClusterIcon"
            ](this, this._config, iloader);
          }
          /**
          ...
          _createClass(_default, [
            {
              ...
              value: function addMarker(marker, tile) {
                ...
                if (
                  this._config.swarmModeEnabled &&
                  this._config.swarmAlg === 1
                ) {
                  if (!this._gridids) {
                    this._gridids = [];
                  }
            ...
            },
            {
              ...
              value: function _calculateBounds() {
                this._bounds = _LLBBox__WEBPACK_IMPORTED_MODULE_1__["LLBBox"]
                  ...
                  .extendSize(
                    this._config.gridSize * Math.pow(2, -this._map.zoom())
                  );
              },
              /**
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _default = function _default(options) {
          ...
          this.swarmAlg = options.swarmAlg
            ? parseInt(options.swarmAlg, 10)
            : null;
          this.styles = options.styles || null;
          this.onClickCenter = options.onClickCenter || false;
          this.swarmGridLength = options.swarmGridLength
            ? parseInt(options.swarmGridLength, 10)
            : null;
          this.swarmMarkersMaxLimit = options.swarmMarkersMaxLimit
            ? parseInt(options.swarmMarkersMaxLimit, 10)
            : null;
          this.swarmMarkersAmountAdjust = options.swarmMarkersAmountAdjust;
          this.swarmMarkersMaxAmountPerTile =
            options.swarmMarkersMaxAmountPerTile
          ...
          _createClass(ClusterIcon, [
            {
              ...
              value: function show() {
                ...
                if (!this._config.swarmModeEnabled) {
                  ...
                  if (
                    this._cluster._markers.length < this._config.minClusterSize
                  ) {
                  ...
                  if (this._clusterMarker.active()) {
                    ...
                    if (this._config.drawMarkerArea) {
                      this._poly = new longdo.Polygon(
                        this._cluster._bounds.getRectVertex(),
                        {
                  ...
                  var amounts = new Array(
                    this._config.swarmGridLength * this._config.swarmGridLength
                  ).fill(0);
                  var sum = 0;
                  ...
                  while (len--) {
                    ...
                    if (
                      amounts[idx] % this._config.swarmMarkersConstPerGrid ===
                      0
                    ) {
                      if (!m.active()) {
                  ...
                  while (len--) {
                    ...
                    if (
                      this.swarmAlg2Decider(
                        amount,
                        this._cluster._markers.length - len - 1
                      )
                    ) {
                      if (!_m.active()) {
            ...
            },
            {
              ...
              value: function setSums(sums) {
                ...
                if (this._clusterMarker && this._clusterMarker.element()) {
                  this._iloader.changeNumber(
                    this._clusterMarker.element(),
                    this._sums
                  );
                }
              },
          ...
          _createClass(IconLoader, [
            {
              ...
              value: function load(url, width, height, minThreshold, callback) {
                ...
                img.onload = function () {
                  ...
                  if (
                    _toConsumableArray(that._images.values()).every(function (
                      elm
                    ) {
                      return elm.ready;
                    })
            ...
            },
            {
              ...
              value: function loadStyles(styles) {
                styles.sort(function (elm1, elm2) {
                  return elm1.minThreshold < elm2.minThreshold
                    ? 1
                    : elm1.minThreshold === elm2.minThreshold
                    ? 0
                    : -1;
                });
            ...
            },
            {
              ...
              value: function getIcon(index) {
                ...
                if (this.useDefault || typeof index === "undefined") {
                  ...
                  elm.className =
                    "marker-cluster marker-cluster-small leaflet-marker-icon";

                  if (this._config.customOuterClusterCSS) {
                    for (var key in this._config.customOuterClusterCSS) {
                      if (
                        Object.hasOwnProperty.call(
                          this._config.customOuterClusterCSS,
                          key
                        )
                      ) {
                        var styleOuterClusterObj =
                          this._config.customOuterClusterCSS[key];
                  ...
                  if (this._config.customInnerClusterCSS) {
                    for (var _key in this._config.customInnerClusterCSS) {
                      if (
                        Object.hasOwnProperty.call(
                          this._config.customInnerClusterCSS,
                          _key
                        )
                      ) {
                        var styleInnerClusterObj =
                          this._config.customInnerClusterCSS[_key];
                  ...
                  if (this._config.customTextClusterCSS) {
                    for (var _key2 in this._config.customTextClusterCSS) {
                      if (
                        Object.hasOwnProperty.call(
                          this._config.customTextClusterCSS,
                          _key2
                        )
                      ) {
                        var styleTextObj =
                          this._config.customTextClusterCSS[_key2];
                  ...
                  _elm.style.background = "url('".concat(
                    encodeURI(img.src),
                  ...
                  if (this._config.customTextClusterCSS) {
                    for (var _key3 in this._config.customTextClusterCSS) {
                      if (
                        ...
                        var _styleTextObj =
                          this._config.customTextClusterCSS[_key3];
            ...
            },
            {
              ...
              value: function changeNumber(element, num) {
                if (this.useDefault) {
                  ...
                  element.children[0].innerText = "".concat(
                    num.toLocaleString()
                  );
                  ...
                  while (len--) {
                    ...
                    if (num >= this._images.get(img).minThreshold) {
                      ...
                      elm = elm.children[0];
                      elm.style.background = "url('".concat(
                        encodeURI(img.src),
                        "') no-repeat center top"
                      );
                      elm.style.width = "".concat(img.width, "px");
            ...
            [
              ...
              },
              {
                ...
                value: function remove(location) {
                  ...
                  this._originalLocationList =
                    this._originalLocationList.filter(function (e) {
                      return e !== location;
                    });
                  this._bounds = this.empty()
                    ? null
                    : longdo.Util.locationBound(this._locationList);
                },
                /**
              ...
              },
              {
                ...
                value: function getNxNGridCord(loc, n) {
                  ...
                  var ylen =
                    (this._lat2y(this._bounds.maxLat) -
                      this._lat2y(this._bounds.minLat)) /
                    n;
                  var lonoffset = loc.lon - this._bounds.minLon;

                  var yoffset =
                    -this._lat2y(loc.lat) + this._lat2y(this._bounds.maxLat);
    ...
    */
              ...
              },
              {
                ...
                value: function _y2lat(y) {
                  return (
                    (Math.atan(Math.exp(y / (180 / Math.PI))) / (Math.PI / 4) -
                      1) *
                    90
                  );
                },
              ...
              },
              {
                ...
                value: function _lat2y(lat) {
                  return (
                    Math.log(Math.tan((lat / 90 + 1) * (Math.PI / 4))) *
                    (180 / Math.PI)
                  );
                },
              },
  ...
  \******************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _LLBBox__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./LLBBox */ "./src/LLBBox.js");
        /* harmony import */ var _ConfigHandler__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./ConfigHandler */ "./src/ConfigHandler.js");
        /* harmony import */ var _Icon__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./Icon */ "./src/Icon.js");
        /* harmony import */ var _Cluster__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./Cluster */ "./src/Cluster.js");
        function _classCallCheck(instance, Constructor) {
          if (!(instance instanceof Constructor)) {
            throw new TypeError("Cannot call a class as a function");
          }
        ...
        if (typeof window.longdo === "undefined") {
          throw new Error(
            "longdo API must be loaded before the longdomap markercluster plugin"
          );
        }
        ...
        var MarkerCluster = /*#__PURE__*/ (function () {
          ...
          function MarkerCluster(map, options) {
            ...
            this._ready = false;
            this.overlay = [];
            this.config = new _ConfigHandler__WEBPACK_IMPORTED_MODULE_1__[
              "default"
            ](options);
            this._iloader = new _Icon__WEBPACK_IMPORTED_MODULE_2__[
              "IconLoader"
            ](this, this.config);
            this._projection = longdo.Projections.EPSG3857;
            var that = this;
                  ...
                  while (len2--) {
                    ...
                    if (d < distance) {
                      ...
                      for (var index = zoom; index <= 20; index++) {
                        var isinCluster = cl.isMarkerInClusterBoundsAtZoom(
                          marker,
                          index
                        );
                        ...
                        if (!isinCluster) {
                          ...
                          if (that.config.onClickCenter) {
                            ...
                            while (zoomTime--) {
                              avgLoc = longdo.Util.averageLocation(
                                that._projection,
                                avgLoc,
                                overlay.location()
                              );
          ...
          _createClass(MarkerCluster, [
            ...
            },
            {
              ...
              value: function setSelectedMarker(_overlay) {
                if (
                  _overlay &&
                  _overlay.element() &&
                  _overlay.element().classList.contains("ldmap_clickable")
                ) {
            ...
            },
            {
              ...
              value: function _createClusters() {
                var mapBounds = _LLBBox__WEBPACK_IMPORTED_MODULE_0__[
                  "LLBBox"
                ].generateFrom(this._map.bound());
                var bounds = mapBounds.extendSize(
                  this.config.gridSize * Math.pow(2, -this._map.zoom())
                );
            ...
            },
            {
              ...
              value: function _addToClosestCluster(marker) {
                ...
                if (
                  ...
                  var _cluster = new _Cluster__WEBPACK_IMPORTED_MODULE_3__[
                    "default"
                  ](this, this.config, this._iloader);
            ...
            },
            {
              ...
              value: function _addToTiledCluster(marker) {
                ...
                var locationToTile = function locationToTile(loc) {
                  var point = longdo.Util.locationToPoint(
                    longdo.Projections.EPSG3857,
                    loc
                  );
                ...
                var cluster = new _Cluster__WEBPACK_IMPORTED_MODULE_3__[
                  "default"
                ](this, this.config, this._iloader);
                cluster.u = tile.u;
                cluster.v = tile.v;
            ...
            },
            {
              ...
              value: function removeMarkers(markers) {
                var markersCopy =
                  markers === this._markers ? this._markers.slice() : markers;
                var removed = false;
  ...
  \**********************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _MarkerCluster__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./MarkerCluster */ "./src/MarkerCluster.js");
